  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/50 bg-white/72 backdrop-blur-xl">
      <div className="mx-auto flex h-[4.5rem] max-w-7xl items-center justify-between gap-2 px-3 sm:h-20 sm:px-6 lg:px-8">
        <Link href="/" aria-label="Jordan Cleans home" className="group flex min-w-0 items-center gap-2">
          ...
          <span className="jordan-rainbow-logo text-[1.05rem] font-black uppercase tracking-[0.12em] sm:text-2xl">Jordan Cleans</span>
        </Link>
      ...
      <style>{`
        .jordan-rainbow-logo {
          ...
          animation: jordan-rainbow-shift 5s ease-in-out infinite;
          white-space: nowrap;
        }
        @keyframes jordan-rainbow-shift {
