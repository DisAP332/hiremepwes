    ...
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="card-pop mt-8 p-8">
        ...
        <p className="mt-3 leading-8 text-ink/65">
          The normal service area is Cincinnati and surrounding areas within
          about 10 miles. Extra travel may include a small fee, always confirmed
          before scheduling. Cleaning customers who can provide supplies are
